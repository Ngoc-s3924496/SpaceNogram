    ...
    var body: some View{
        ZStack{
                                        ...
                                        ForEach(0..<7){column in
                                            if column == 0{
                                                ...
                                                if(gameGrid.0[row-1][column-1] == "e" || gameGrid.0[row-1][column-1] == "c"){
                                                    Ipad11ChosenTileEasy(win: $win, gameGrid: $gameGrid, row: row-1, column: column-1)
                                                } else if(gameGrid.0[row-1][column-1] == "b" || gameGrid.0[row-1][column-1] == "B"){
                                                    Ipad11BombTileEasy(health: $health, level: $level, gameGrid: $gameGrid, row: row-1, column: column-1)
                                                } else if (gameGrid.0[row-1][column-1] == "o" || (gameGrid.0[row-1][column-1] == "x")){
                                                    Ipad11StartEndTileEasy()
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    HStack(spacing: 3){
                                        ForEach(0..<9){column in
                                            if column == 0{
                                                ...
                                                if(gameGrid.0[row-1][column-1] == "e" || gameGrid.0[row-1][column-1] == "c"){
                                                    Ipad11ChosenTileMedium(win: $win, gameGrid: $gameGrid, row: row-1, column: column-1)
                                                } else if(gameGrid.0[row-1][column-1] == "b" || gameGrid.0[row-1][column-1] == "B"){
                                                    Ipad11BombTileMedium(health: $health, level: $level, gameGrid: $gameGrid, row: row-1, column: column-1)
                                                } else if (gameGrid.0[row-1][column-1] == "o" || (gameGrid.0[row-1][column-1] == "x")){
                                                    Ipad11StartEndTileMedium()
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    HStack(spacing: 3){
                                        ForEach(0..<11){column in
                                            if column == 0{
                                                ...
                                                if(gameGrid.0[row-1][column-1] == "e" || gameGrid.0[row-1][column-1] == "c"){
                                                    Ipad11ChosenTileHard(win: $win, gameGrid: $gameGrid, row: row-1, column: column-1)
                                                } else if(gameGrid.0[row-1][column-1] == "b" || gameGrid.0[row-1][column-1] == "B"){
                                                    Ipad11BombTileHard(health: $health, level: $level, gameGrid: $gameGrid, row: row-1, column: column-1)
                                                } else if (gameGrid.0[row-1][column-1] == "o" || (gameGrid.0[row-1][column-1] == "x")){
                                                    Ipad11StartEndTileHard()
                                                }
                                            }
                                        }
                                    }
            ...
            if self.showPause{
                ...
                PauseViewIpad11(language: $language, difficulty: $difficulty, showPause: $showPause, win: $win, gameGrid: $gameGrid, health: $health, level: $level, startTimer: startTimer, resetTimer: resetTimer, updateUserPlayer: updateUserPlayer)
            ...
            if self.win{
                ...
                WinViewIpad11(language: $language, difficulty: $difficulty, level: $level, health: $health, win: $win, gameGrid: $gameGrid, elapsedTime: $elapsedTime, resetTimer: resetTimer, updateUserPlayer: updateUserPlayer, updateTimeBadge: updateTimeBadge)
                    .environmentObject(GameDataStore())
                    .onAppear{
                        stopTimer()
                    }
            ...
            if health == 0{
                Color.black.opacity(0.6).edgesIgnoringSafeArea(.all)
                LoseViewIpad11(language: $language, difficulty: $difficulty, level: $level, health: $health, win: $win, gameGrid: $gameGrid, resetTimer: resetTimer, updateUserPlayer: updateUserPlayer)
                    .environmentObject(GameDataStore())
                    .onAppear{
                        stopTimer()
                    }
            ...
            if self.showHowToPlay{
                ...
                HowToPlayViewIpad11(showHowToPlay: $showHowToPlay, language: $language)
            }
        }.onAppear{
            if level == 1{
