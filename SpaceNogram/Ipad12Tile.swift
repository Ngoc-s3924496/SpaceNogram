...
struct Ipad12ChosenTileEasy: View{
...
struct Ipad12ChosenTileMedium: View{
    @Binding var win: Bool
    @Binding var gameGrid: ([[Character]], [Int], [Int], [Int], [Int])
    @AppStorage("soundSetting") private var sound: Bool = true
    var row: Int
...
struct Ipad12ChosenTileHard: View{
    @Binding var win: Bool
    @Binding var gameGrid: ([[Character]], [Int], [Int], [Int], [Int])
    @AppStorage("soundSetting") private var sound: Bool = true
    var row: Int
...
struct Ipad12BombTileEasy: View{
...
struct Ipad12BombTileMedium: View{
    @State private var showBomb: Bool = false
    @State private var showExplosion: Bool = false
    @State private var superBomb: Bool = false
    @Binding var health: Int
...
struct Ipad12BombTileHard: View{
    @State private var showBomb: Bool = false
    @State private var showExplosion: Bool = false
    @State private var superBomb: Bool = false
    @Binding var health: Int
...
struct Ipad12StartEndTileEasy: View{
    var body: some View{
        ZStack{
            Image("Tile")
                .resizable()
...
struct Ipad12StartEndTileMedium: View{
    var body: some View{
        ZStack{
            Image("Tile")
                .resizable()
...
struct Ipad12StartEndTileHard: View{
    var body: some View{
        ZStack{
            Image("Tile")
                .resizable()
